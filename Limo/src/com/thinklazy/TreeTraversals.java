...
public class TreeTraversals {
    ...
    public static void main(String[] args) {
        ...
        TreeUtils.printLevelOrder(tree);
         ...
         System.out.println("\nPreorder print of tree:"); preorderPrint(tree);
        /* 
         * System.out.println("\n\nIndented preorder print of tree:"); preorderPrint(tree, "");
         * 
         * System.out.println("\nPostorder print of tree:"); postorderPrint(tree);
         * 
         * System.out.println("\n\nIndented postorder print of tree:"); postorderPrint(tree, "");
         * 
        ...
        bfs(tree);
        /*
         * System.out.println("\nRecursive depth-first search:"); recursiveDfsSearch(tree);
         */
    }

    /**
     * Traverses the given tree in preorder, printing node values on a single line.
     */
    ...
    /**
     * Traverses the given tree in preorder, printing node values indented and on multiple lines.
     */
    ...
    /**
     * Traverses the given tree in postorder, printing node values on a single line.
     */
    ...
    /**
     * Traverses the given tree in postorder, printing node values indented and on multiple lines. I
     * did this out of curiosity, and find the resultant output very difficult to read.
     */
    ...
    /**
     * Performs a depth-first search, starting from the given node, for any node that satisfies the
     * condition isGoal(node).
     * 
    ...
    /**
     * Performs a breadth-first search, starting from the given node, for any node that satisfies
     * the condition isGoal(node).
     * 
     * @param root The root of the tree or subtree to be searched.
     * @return True if a goal node could be found.
     */
    ...
    /**
     * Defines a couple of nodes in the tree to be goal nodes. There is no "deeper meaning" to these
     * nodes; it's just a hack to test out the search methods.
     */
