...
//Player out of class
// player type should be enum

//Move should be stateless.. u hve to inject board.. so board should be passed on to the move.

//Game is responsible for winning.. bot board.
//class TicTacToe should be composition of Board, WinStaragery, Players((MoveMethod))

//hash value.. of board.. game state. along with move method.


//single responsibility principle..
//server decided by faster connection.

//Bonjour : apply protocol for discovery in
//MDNS : same subnet discovery
...
class TicTacToe {
    ...
    //Can be a separate public class.
    class Player {
        private String name;
    ...
    //setMove, isWinningConfig, getRowString : should go to a new class Board. 
    ...
    //To make it faster.. we can pass the last move position to this method.. and search just based on that build up
    //Alternatively we can have a state buildup.. which can give even faster success lookup.
    private WinConfig isWinningConfig() {
        ...
        //REV NOT good..hardcoding.. if we want to have more than 3x3 grid..
        // diags 
    ...
    public static void main(String[] args) {
        ...
        while (game.isWinningConfig() == WinConfig.NONE) {
            do {
                move1 = game.getplayer1().getMove(); // getmove is a blocking call.. blocking in interrupt from keyboard.. 
